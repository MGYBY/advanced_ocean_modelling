...
INTEGER(4), PARAMETER :: nx = 25 ! number of grid points x-direction
INTEGER(4), PARAMETER :: ny = 25 ! number of grid points y-direction
INTEGER(4), PARAMETER :: nz = 25 ! number of grid points z-direction
