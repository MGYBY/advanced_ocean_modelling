...
INTEGER(4), PARAMETER :: nx = 101 ! number of grid points x-direction
INTEGER(4), PARAMETER :: ny = 101 ! number of grid points y-direction
INTEGER(4), PARAMETER :: nz = 5 ! number of grid points z-direction
...
REAL :: taux(0:ny+1,0:nx+1), tauy(0:ny+1,0:nx+1) ! wind-stress arrays

REAL :: uu, vv, ww
REAL :: tra(ntra,3) ! tracer coordinates
REAL :: xlen, ylen, zlen, xpos, ypos, zpos, randm
...
REAL :: f(0:ny+1), alpha, beta, fstar
