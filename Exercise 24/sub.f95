...
DO j = 1,ny
  WRITE(50,'(201F12.6)')(depth(j,k),k=1,nx)
END DO
CLOSE(50)
...
DO k = 0,nx+1
  ...
  DO i = nb+1,nz+1
   wet(i,j,k) = .false.
  END DO
! enable rigid-lid approximation
wet(0,j,k) = .false.
END DO
END DO
...
!IF(i<2) wurz = windmix ! disable wind mixing
kz(i,j,k) = wurz
