...
INTEGER(4), PARAMETER :: nx = 120 ! horizontal dimension	
...
INTEGER :: n,i,k, ist
REAL :: randm, time, period

INTEGER :: ibu(0:nx+1), ib(0:nx+1) 
REAL :: tbu(nx) ! bottom-stress parameters

REAL :: evap(1:nx) ! evaporation
REAL :: betaS0

REAL :: rho(0:nz+1,0:nx+1),rhon(0:nz+1,0:nx+1), rhozero(0:nz+1)
REAL :: p(0:nz+1,0:nx+1) ! hydrostatic pressure
REAL :: dq(0:nz+1,0:nx+1) ! pressure correction (depends on width)
REAL :: dqq(0:nz+1,0:nx+1) ! pressure correction
...
REAL :: c2(0:nz+1,0:nx+1), c2n(0:nz+1,0:nx+1)  
REAL :: c3(0:nz+1,0:nx+1), c3n(0:nz+1,0:nx+1)  
...
! output arrays
REAL :: etaMAX(0:nx+1),etaMIN(0:nx+1) 
REAL :: rhoM(0:nz+1,0:nx+1),uM(0:nz+1,0:nx+1),wM(0:nz+1,0:nx+1) 
