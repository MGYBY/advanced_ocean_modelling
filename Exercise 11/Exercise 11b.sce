...
//============================================
// Animation of salinity field. Density contours are overlaid.
// Author: Jochen Kaempf, March 2015 (update)

f = gcf(); f.color_map = jetcolormap(64); f.figure_size = [1000,400]; scf(0);  

// read input data
rho1=read("rho.dat",-1,201); s1=read("s.dat",-1,201); // 
...
rho = rho1(itop:ibot,1:201)'; s = s1(itop:ibot,1:201); 

drawlater; clf;

// 2d colour plot of salinity field
Sgrayplot(x,-z,s',zminmax=[0.0,max(s')]);
