...
// read input data
rho1=read("rho.dat",-1,201); t1=read("t.dat",-1,201); // 
...
rho = rho1(itop:ibot,1:201)'; t = t1(itop:ibot,1:201); 

drawlater; clf(); 

// 2d colour plot of temperature field
Sgrayplot(x,-z,t',zminmax=[0.0,11]);
